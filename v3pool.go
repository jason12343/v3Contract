...
func (_V3pool *V3poolCaller) LmPool(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _V3pool.contract.Call(opts, &out, "lmPool")
...
//
// Solidity: function lmPool() view returns(address)
func (_V3pool *V3poolSession) LmPool() (common.Address, error) {
	return _V3pool.Contract.LmPool(&_V3pool.CallOpts)
}

// LmPool is a free data retrieval call binding the contract method 0x540d4918.
//
// Solidity: function lmPool() view returns(address)
func (_V3pool *V3poolCallerSession) LmPool() (common.Address, error) {
	return _V3pool.Contract.LmPool(&_V3pool.CallOpts)
}
...
func (_V3pool *V3poolTransactor) SetFeeProtocol(opts *bind.TransactOpts, feeProtocol0 uint32, feeProtocol1 uint32) (*types.Transaction, error) {
...
//
// Solidity: function setFeeProtocol(uint32 feeProtocol0, uint32 feeProtocol1) returns()
func (_V3pool *V3poolSession) SetFeeProtocol(feeProtocol0 uint32, feeProtocol1 uint32) (*types.Transaction, error) {
...
//
// Solidity: function setFeeProtocol(uint32 feeProtocol0, uint32 feeProtocol1) returns()
func (_V3pool *V3poolTransactorSession) SetFeeProtocol(feeProtocol0 uint32, feeProtocol1 uint32) (*types.Transaction, error) {
	return _V3pool.Contract.SetFeeProtocol(&_V3pool.TransactOpts, feeProtocol0, feeProtocol1)
}
...
func (_V3pool *V3poolTransactor) SetLmPool(opts *bind.TransactOpts, _lmPool common.Address) (*types.Transaction, error) {
	return _V3pool.contract.Transact(opts, "setLmPool", _lmPool)
}

// SetLmPool is a paid mutator transaction binding the contract method 0xcc7e7fa2.
//
// Solidity: function setLmPool(address _lmPool) returns()
func (_V3pool *V3poolSession) SetLmPool(_lmPool common.Address) (*types.Transaction, error) {
	return _V3pool.Contract.SetLmPool(&_V3pool.TransactOpts, _lmPool)
}

// SetLmPool is a paid mutator transaction binding the contract method 0xcc7e7fa2.
//
// Solidity: function setLmPool(address _lmPool) returns()
func (_V3pool *V3poolTransactorSession) SetLmPool(_lmPool common.Address) (*types.Transaction, error) {
	return _V3pool.Contract.SetLmPool(&_V3pool.TransactOpts, _lmPool)
}
...
// V3poolSetLmPoolEventIterator is returned from FilterSetLmPoolEvent and is used to iterate over the raw logs and unpacked data for SetLmPoolEvent events raised by the V3pool contract.
type V3poolSetLmPoolEventIterator struct {
	Event *V3poolSetLmPoolEvent // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *V3poolSetLmPoolEventIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(V3poolSetLmPoolEvent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *V3poolSetLmPoolEventIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *V3poolSetLmPoolEventIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// V3poolSetLmPoolEvent represents a SetLmPoolEvent event raised by the V3pool contract.
type V3poolSetLmPoolEvent struct {
	Addr common.Address
	Raw  types.Log // Blockchain specific contextual infos
}
...
func (_V3pool *V3poolFilterer) FilterSetLmPoolEvent(opts *bind.FilterOpts) (*V3poolSetLmPoolEventIterator, error) {

	logs, sub, err := _V3pool.contract.FilterLogs(opts, "SetLmPoolEvent")
	if err != nil {
		return nil, err
	}
	return &V3poolSetLmPoolEventIterator{contract: _V3pool.contract, event: "SetLmPoolEvent", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SetLmPoolEvent(address addr)
func (_V3pool *V3poolFilterer) WatchSetLmPoolEvent(opts *bind.WatchOpts, sink chan<- *V3poolSetLmPoolEvent) (event.Subscription, error) {

	logs, sub, err := _V3pool.contract.WatchLogs(opts, "SetLmPoolEvent")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(V3poolSetLmPoolEvent)
				if err := _V3pool.contract.UnpackLog(event, "SetLmPoolEvent", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SetLmPoolEvent(address addr)
func (_V3pool *V3poolFilterer) ParseSetLmPoolEvent(log types.Log) (*V3poolSetLmPoolEvent, error) {
	event := new(V3poolSetLmPoolEvent)
	if err := _V3pool.contract.UnpackLog(event, "SetLmPoolEvent", log); err != nil {
		return nil, err
	}
